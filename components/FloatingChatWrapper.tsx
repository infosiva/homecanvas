...
export default function FloatingChatWrapper() {
  ...
  const [msgs, setMsgs] = useState<{ role: 'user' | 'bot'; text: string }[]>([
    { role: 'bot', text: "Hi! Tell me your brand — I'll help generate blog, podcast, video and social content 🚀" },
  ])
          ...
          >
            <div style={{ flexShrink: 0, padding: '12px 16px', borderBottom: `1px solid rgba(${ACCENT_RGB},0.2)`,
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: '#eef' }}>CampaignForge AI</span>
