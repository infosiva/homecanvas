export default function PrivacyPage() {
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px', fontFamily: 'system-ui', lineHeight: 1.7, color: '#1a1a1a' }}>
      ...
      <p>HomeCanvas collects only information you provide directly — such as your email address when you sign up, and anonymous usage data to improve the service. We do not sell your data.</p>
      ...
      <p>You can request deletion of your account and data at any time by emailing <a href="mailto:hello@homecanvas.app" style={{ color: '#e11d48' }}>hello@homecanvas.app</a>.</p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 32 }}>Contact</h2>
      <p>Questions? Email <a href="mailto:hello@homecanvas.app" style={{ color: '#e11d48' }}>hello@homecanvas.app</a></p>
    </main>
  )
}
